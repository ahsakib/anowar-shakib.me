...
export default function HeroSection() {
  ...
  return (
    <section className="pt-32 pb-20 min-h-screen flex items-center relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-32 h-32 border border-green-500/20 rounded-lg transform rotate-45 animate-float animation-delay-1000"></div>
      <div className="absolute bottom-1/4 right-1/4 w-24 h-24 border border-blue-500/20 rounded-full animate-float animation-delay-1500"></div>
      <div className="absolute top-2/3 left-1/3 w-16 h-16 border border-purple-500/20 transform rotate-12 animate-float animation-delay-500"></div>

      {/* Social Links Sidebar - Enhanced */}
      <div className="fixed left-0 top-1/2 -translate-y-1/2 flex flex-col items-center z-10">
        <div className="w-10 h-64 bg-[#0a1120]/80 backdrop-blur-sm border-r border-green-500/20 flex flex-col items-center justify-center gap-6">
          <a href="#" target="_blank" aria-label="GitHub" className="social-icon" rel="noreferrer">
            <div className="text-gray-400 hover:text-green-500 transition-all duration-300 transform hover:scale-110 hover:rotate-12">
              <svg
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-wrap gap-4 animate-fadeIn animation-delay-1000">
            ...
            <button className="border border-green-500 text-green-500 hover:bg-green-500/10 px-6 py-3 rounded-md transition-all duration-300 transform hover:scale-105 flex items-center gap-2">
              About Me
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
          ...
          {/* Scroll indicator */}
          <div
            className="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center animate-bounce animation-delay-2000 cursor-pointer"
            onClick={() => {
